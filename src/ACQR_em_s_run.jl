function ACQR_em_s_run(y,nx::Int;max_iter::Int=100,tol::Float64=1e-6,txo::Bool=true)
	#=
	...
	# em
	A,C,Q,R,m1,P1,loglikv,aic = ACQR_em_s(y,Ai,Ci,Qi,Ri,m1i,max_iter,tol,txo)

	# output
	m = Dict("A"=>A,"C"=>C,"Q"=>Q,"R"=>R,"m1"=>m1,"P1"=>P1,
	"loglikv"=>loglikv[end],"aic"=>aic)
	return m
